...
{ 
  long double limit = 1000000000;

  long count1 = CacheUnfriendlySieve(limit);
  cout<< "Finding primes till " << limit <<endl;
  cout << "Unfriendly " << count1 << endl;
  cout << "Time : " << t << endl;

  long count2 = CacheFriendlySieve(limit);
  cout << "Friendly " << count2 << endl;
  cout << "Time : " << t << endl;

  long count3 = ParallelSieve(limit);
